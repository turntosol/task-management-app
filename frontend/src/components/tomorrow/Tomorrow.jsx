...
const Tomorrow = ({ tags = [] }) => {
    ...
    const { bgColor, changeBgColor } = useViewSetting('tomorrow', '#fcfcfc');
...
const tomorrowStr = formatLocalDate(tomorrowDate);
    ...
    return (
        <div className="tomorrow" style={{ backgroundColor: bgColor }}>
